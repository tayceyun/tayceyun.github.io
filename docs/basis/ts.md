...
示例
![](/img/images/ts-img/创建类.png)

#### 类的成员修饰符

![](/img/images/ts-img/修饰符.png)
...
![](/img/images/ts-img/declare.png)
![](/img/images/ts-img/vue.png)

### tsconfig.json 文件

![](/img/images/ts-img/config.png)
![](/img/images/ts-img/config使用.png)
