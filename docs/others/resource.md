...
![vue源码中的模块](/img/images/resource/workspace.png)

pnpm 并不是通过目录名称，而是通过目录下 package.json 文件的 name 字段来识别仓库内的包与模块的。

![vue源码示例](/img/images/resource/pnpm.png)
...
![](/img/images/resource/vnode.png)

组件 vnode 示例

![](/img/images/resource/vnode组件.png)
...
![](/img/images/resource/setupRender.png)
