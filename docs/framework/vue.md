...
![](/img/images/vue/声明式.png)

### MVVM 模型

![](/img/images/vue/mvvm.png)
...
![](/img/images/vue/节点.png)

![](/img/images/vue/节点移动.png)

- 没有 key，使用`patchUnkeyedChildren`方法

![](/img/images/vue/没有key.png)
...
![](/img/images/vue/model组件.png)

#### 组件 v-model 的实现

![](/img/images/vue/model实现.png)

组件可以绑定多个 v-model

`  <SonPage v-model:name="sonComponent" v-model:age="ageProps"></SonPage>`

![](/img/images/vue/多个model.png)

## 组件

![](/img/images/vue/组件化.png)

#### 组件名称

![](/img/images/vue/组件名称.png)

#### 全局组件注册

![](/img/images/vue/全局组件.png)

#### 局部组件注册

![](/img/images/vue/局部组件.png)
...
![](/img/images/vue/attr.png)

**禁用 Attribute 继承和多根节点:`inheritAttrs:false`**

![](/img/images/vue/禁用attr.png)
...
![](/img/images/vue/ref.png)

![](/img/images/vue/ref2.png)

### $parent和$root

![](/img/images/vue/parent.png)

## 插槽 slot

![](/img/images/vue/插槽.png)
![](/img/images/vue/插槽2.png)
...
![](/img/images/vue/动态插槽.png)

### 渲染作用域

![](/img/images/vue/渲染作用域.png)

### 作用域插槽：子组件将值传递给父组件

父组件使用作用域插槽：

![](/img/images/vue/作用域插槽.png)

子组件插槽：

![](/img/images/vue/作用域插槽2.png)

![](/img/images/vue/作用域插槽3.png)
...
![](/img/images/vue/include.png)

![](/img/images/vue/其它属性.png)
...
![](/img/images/vue/默认打包.png)

![](/img/images/vue/工厂函数.png)

![](/img/images/vue/工厂函数2.png)

## mixin

### 基础使用

![](/img/images/vue/mixin.png)

### 合并规则

![](/img/images/vue/合并规则.png)

### 全局混入

main.js 文件

![](/img/images/vue/全局混入.png)

## 从 options api 到 composition api

### options api 弊端

![](/img/images/vue/options.png)

### setup 函数

![](/img/images/vue/setup.png)
...
![](/img/images/vue/counter.png)

![](/img/images/vue/counter2.png)
...
![](/img/images/vue/reactive.png)

### ref

![](/img/images/vue/ref理解.png)

template 中的 ref 对象会被自动解包

模板中的解包是浅层解包（存在矛盾:使用时不需要写`.value`，函数修改时需要写`.value`）

![](/img/images/vue/ref理解2.png)
...
![](/img/images/vue/readonly.png)

![](/img/images/vue/readonly2.png)
...
![](/img/images/vue/proxy.png)

### toRefs

![](/img/images/vue/torefs.png)

### toRef

只解构一个值使用 toRef

![](/img/images/vue/toref.png)

### unRef、isRef、shallowRef、triggerRef

![](/img/images/vue/unref.png)

### 在 setup 函数中不能使用 this

![](/img/images/vue/this.png)

![](/img/images/vue/this2.png)

### computed

computed 返回的是 computedRef 对象

![](/img/images/vue/computedref.png)
...
Composition API 是基于 Vue 的响应式系统实现的，与 React Hook 的相比，方法、变量声明在 setup 函数内，一次组件实例化只调用一次 setup，而 React Hook 每次重新渲染都需要调用 Hook。
...
![](/img/images/vue/生命周期.png)

### watch

返回值从 proxy 对象变为普通对象的写法：

![](/img/images/vue/watch.png)

侦听多个数据源

![](/img/images/vue/watch2.png)

watch 选项

![](/img/images/vue/watch3.png)

### watchEffect

在执行过程中，会自动收集函数中的所有依赖

![](/img/images/vue/依赖.png)

停止侦听

![](/img/images/vue/停止.png)

hook/useTitle.js

![](/img/images/vue/usetitle.png)

index.vue 使用 useTitle

![](/img/images/vue/使用usetitle.png)

### definProps 和 defineEmits

![](/img/images/vue/defineprops.png)

### defineExpose

![](/img/images/vue/defineexpose.png)
...
![](/img/images/vue/后端路由.png)

② 前后端分离阶段：将 url 传递给服务器，服务器根据地址将仅返回页面的基本结构，页面数据由前端发送 ajax 请求来获取数据并渲染到页面上。

![](/img/images/vue/前后分离.png)

③ 前端路由（SPA：single page application）阶段：路由与页面映射关系由前端来维护，不同路由显示不同页面。

![](/img/images/vue/前端路由.png)

url 的 hash

![](/img/images/vue/hash.png)

url 的 history

![](/img/images/vue/history.png)

### vue-router 简介

![](/img/images/vue/路由简介.png)

### router 使用步骤

![](/img/images/vue/使用步骤.png)
...
![](/img/images/vue/link.png)

### 动态路由

![](/img/images/vue/动态路由.png)
...
![](/img/images/vue/动态添加路由.png)

### 删除路由

![](/img/images/vue/删除路由.png)

### 路由守卫

![](/img/images/vue/路由守卫.png)
...
导航解析流程：![](/img/images/vue/导航.png)

### 状态管理（vuex）

![](/img/images/vue/状态管理.png)

### 单一状态树

![](/img/images/vue/状态树.png)
...
![](/img/images/vue/mapgetter.png)

### mutation

![](/img/images/vue/mutation.png)
...
![](/img/images/vue/常量.png)

#### mapMutations 映射

![](/img/images/vue/mapmutations.png)

#### setup 使用 mapState 映射函数

![](/img/images/vue/set-mapstate.png)

#### mutation 原则

![](/img/images/vue/原则.png)

### actions

![](/img/images/vue/action.png)
...
![](/img/images/vue/mapAction.png)

#### 在 setup 中使用 actions

![](/img/images/vue/set-action.png)
...
![](/img/images/vue/手动.png)

#### modules 的使用

![](/img/images/vue/modules.png)

在 template 中使用模块中的数据需要采用`state.moduleA.name`的方式，但调用 mutation 和 actions 的方法时不需要根模块

![](/img/images/vue/1.png)

![](/img/images/vue/2.png)

命名空间：`namespaced:true`

修改根模块的 state

![](/img/images/vue/3.png)
...
![](/img/images/vue/5.png)

### state

![](/img/images/vue/6.png)

![](/img/images/vue/7.png)
...
![](/img/images/vue/8.png)

同样可以通过 new Promise 获取 actions 何时结束（同 vuex）

![](/img/images/vue/9.png)

## axios

### axios 请求方式

![](/img/images/vue/10.png)

发送 request 请求

![](/img/images/vue/11.png)

发送 get 请求

![](/img/images/vue/12.png)

发送 post 请求

![](/img/images/vue/13.png)

axios.all(本质就是 promise.all)

![](/img/images/vue/14.png)

### 常见配置项

![](/img/images/vue/15.png)
...
![](/img/images/vue/16.png)

#### 请求和响应拦截器

![](/img/images/vue/17.png)
...
在书写 vue2 时，由于组件必须只有一个根节点，很 多时候会添加一些没有意义的节点用于包裹。Fragment 组件就是用于解决这个问题的(这和 React 中的 Fragment 组件是一样的)。
...
Portal 提供了一种将子节点渲染到存在于父组件以外的 DOM 节点的方法
...
Suspense 让组件在渲染之前进行“等待”，并在等待时显示 fallback 的内容
