...
![](/img/images/react/核心api.jpg)

#### ① `createSlice`

![](/img/images/react/createSlice.jpg)

#### ② configureStore

![](/img/images/react/configureStore.jpg)
...
![](/img/images/react/后端路由.jpg)

### 前端路由

![](/img/images/react/前端路由.jpg)
...
![](/img/images/react/useTransition.jpg)

### useDeferredValue

概念：useDeferredValue 接受一个值，并返回该值的副本，该副本将推迟到更紧急的更新之后

![](/img/images/react/useDeferr.jpg)
...
![](/img/images/react/hydration.jpg)
